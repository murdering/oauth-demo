...
http://localhost:8080/oauth/authorize?client_id=hugeSpa&redirect_uri=http://localhost:9001/callback&response_type=code&scope=read_userinfo
...
curl -X POST --user hugeSpa:112233 http://localhost:8080/oauth/token -H
